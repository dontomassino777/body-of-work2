...
import { addDoc, collection, doc, deleteDoc, onSnapshot, orderBy, query, serverTimestamp, setDoc } from 'firebase/firestore';
  ...
  return (
    ...
    <div className='bg-white my-7 border rounded-sm'>
        ...
        <div className='flex items-center p-5'>
            <img src={userImg} className='rounded-full h-12 w-12 object-contain border p-1 mr-3' alt="user"/>
